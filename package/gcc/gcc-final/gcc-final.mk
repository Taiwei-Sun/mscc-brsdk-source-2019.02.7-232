...
# And handle their legal info (on target)
define GCC_FINAL_LEGAL_MANIFEST_RUNTIME
	$(foreach l,$(HOST_GCC_FINAL_USR_LIBS),@$(call legal-manifest,TARGET,$(l),$(GCC_FINAL_VERSION),$(GCC_FINAL_LICENSE),$(GCC_FINAL_LICENSE_FILES),$(GCC_FINAL_SOURCE),$(GCC_FINAL_SITE)))
	$(foreach l,$(HOST_GCC_FINAL_USR_LIBS),$(foreach F,$(GCC_FINAL_LICENSE_FILES),@$(call legal-license-file,$(l),$(l)-$(GCC_FINAL_VERSION),"",$(F),$(HOST_GCC_FINAL_DIR)/$(F),TARGET)$(sep)))
endef

HOST_GCC_FINAL_POST_LEGAL_INFO_HOOKS += GCC_FINAL_LEGAL_MANIFEST_RUNTIME
